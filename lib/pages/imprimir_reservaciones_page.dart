...
class ImprimirReservacionesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.teal, // Color de fondo similar al otro código
      ),
      body: Padding(
        padding: const EdgeInsets.all(16), // Añadido padding global
        child: ListView(
          children: [
  ...
  Widget _buildRestaurantTile(BuildContext context, String nombreRestaurante) {
    ...
    return Card(
      margin: const EdgeInsets.symmetric(vertical: 8), // Similar al estilo anterior
      elevation: 4, // Sombra para que las tarjetas se vean elevadas
      child: ListTile(
        ...
        trailing: const Icon(Icons.arrow_forward_ios), // Añadir un icono de flecha
        onTap: () {
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    trailing: const Icon(Icons.picture_as_pdf), // Icono para la generación de PDF
                    onTap: () {
